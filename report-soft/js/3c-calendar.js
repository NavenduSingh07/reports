var cal = {
  ...
  show : function (evt) {
    ...
    // (D2) EDIT EVENT
      ...
      document.getElementById("evttitle").value = edata['evt_type'];
  ...
  save : function (evt) {
    ...
    data.append("txt1", document.getElementById("evttitle").value);
    data.append("txt2", document.getElementById("evttxt").value);
