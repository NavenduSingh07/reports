    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          $sql1 = "SELECT * FROM `employee` WHERE `emp_emailid` = '" . $uname . "'";
          ...
          $sql3 = "SELECT * FROM `reports` WHERE `emp_emailid`='" . $uname . "' AND `date` BETWEEN '$from_date' AND '$to_date' ";
          ...
          $days = (((strtotime("$to_date") - strtotime("$from_date")) / 86400) + 1) - $tsunday;
          $twork = $days * $trep;
          $pending = $twork - $counter;
      ...
      <div class="main">
        ...
        <div class="button">
          ...
          if ($role == 'HR' || $role == 'Manager') {
            echo '<a href="view.php" class="btn btn-primary btn-lg active float-left ml-4" role="button" aria-pressed="true">View Others</a>';
          } ?>
          <?php
        ...
        <a href="export.php?emp_emailid=' . $uname . '&from_date=' . $fdate . '&to_date=' . $tdate . '" class="btn btn-secondary btn-lg active float-right mr-4" role="button" aria-pressed="true">Export</a>
        </div>' ?><br>
        </div><br>

        <div class="card-header mr-4 ml-4">
        ...
        <div class="chart" id="piechart_3d" style="width: 1503px; height: 500px;"></div>
        <br>

        <div class="col-md-12">
          <div class="page-header">
            <h2 class="ml-3">Report</h2>
          </div>
          <form action="insert.php" method="post">
            <div class="form-group">
              <input type="text" name="descr" class="form-control ml-1">
            </div>
            <br>
            <input type="submit" class="btn btn-primary ml-4" name="submit" value="Submit">
          </form><br>
        </div>
        <div class="table">
          <label>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                $from_date = $_GET['from_date'];
                $to_date = $_GET['to_date'];
                $sql = "SELECT * FROM `reports` WHERE `emp_emailid`='" . $uname . "' AND `date` BETWEEN '$from_date' AND '$to_date' ";
