  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
          $id = $_GET['emp_emailid'];
          $sql1 = "SELECT * FROM `employee` WHERE `emp_emailid` = '" . $id . "'";
          ...
          $sql3 = "SELECT * FROM `reports` WHERE `emp_emailid`='" . $id . "' AND `date` BETWEEN '$from_date' AND '$to_date' ";
    ...
    <div class="wrapper">
      ...
      <div class="main">
        ...
        <div class="page-titles">
          <div class="col-12">
            ...
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item"><a href="view.php">View Others</a></li>
        ...
        <a href="export.php?emp_emailid=' . $id . '&from_date=' . $fdate . '&to_date=' . $tdate . '" class="btn btn-secondary btn-lg active float-right mr-4" role="button" aria-pressed="true">Export</a>
        </div>' ?><br>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="hidden" name="emp_emailid" value="<?php if (isset($_GET['emp_emailid'])) {
                                                                    echo $_GET['emp_emailid'];
                                                                  } ?>">
                </div>
              </div>
              <div class="col-md-4">
        ...
        <div class="chart" id="piechart_3d" style="width: 1503px; height: 500px;"></div><br>


        <div class="table">
          <?php
          /**$id = $_GET['emp_emailid'];**/
          echo '<label><h2>Reports of ' . $id . '</h2></label>';
          ?>
          <table class="table">
            <thead>
              <tr>
